...
namespace ProjectTracker.Data.Migrations
{
    ...
    [Migration("20260103102836_GitHubIntegration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectTracker.Core.Entities.GitCommit", b =>
                {
                    b.Property<int>("GitCommitId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GitCommitId"));
                    ...
                    b.Property<string>("AuthorGitHubUsername")
                        .HasMaxLength(100)
                    ...
                    b.HasKey("GitCommitId");

                    b.HasIndex("CommitDate");

                    b.HasIndex("LinkedTaskId");

                    b.HasIndex("GitRepositoryId", "Sha")
                        .IsUnique();

                    b.ToTable("GitCommits", (string)null);
                });

            modelBuilder.Entity("ProjectTracker.Core.Entities.GitFileChange", b =>
                {
                    b.Property<int>("GitFileChangeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GitFileChangeId"));
                    ...
                    b.ToTable("GitFileChanges", (string)null);
                });

            modelBuilder.Entity("ProjectTracker.Core.Entities.GitHubToken", b =>
                {
                    b.Property<int>("GitHubTokenId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GitHubTokenId"));
                    ...
                    b.HasKey("GitHubTokenId");

                    b.HasIndex("UserId");

                    b.ToTable("GitHubTokens", (string)null);
                });

            modelBuilder.Entity("ProjectTracker.Core.Entities.GitRepository", b =>
                {
                    b.Property<int>("GitRepositoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GitRepositoryId"));
            ...
            modelBuilder.Entity("ProjectTracker.Core.Entities.GitCommit", b =>
                {
                    b.HasOne("ProjectTracker.Core.Entities.GitRepository", "Repository")
                        .WithMany("Commits")
                        .HasForeignKey("GitRepositoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjectTracker.Core.Entities.Task", "LinkedTask")
                        .WithMany("LinkedCommits")
            ...
            modelBuilder.Entity("ProjectTracker.Core.Entities.GitFileChange", b =>
                {
                    b.HasOne("ProjectTracker.Core.Entities.GitCommit", "Commit")
            ...
            modelBuilder.Entity("ProjectTracker.Core.Entities.GitRepository", b =>
                {
                    b.HasOne("ProjectTracker.Core.Entities.Project", "Project")
                        ...
                        .HasForeignKey("ProjectTracker.Core.Entities.GitRepository", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
